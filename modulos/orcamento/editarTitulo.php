...
$id_titulo = filter_input(INPUT_POST, "idTit");
...
if (empty(StringUtil::removeEspacos($titulo)) && empty(StringUtil::removeEspacos($num_item))) {
    echo "FALSE";
} else if ($orcTituloDAO->editar($orcTitulo)) {
    echo "TRUE";
} else {
    echo "FALSE";
}
